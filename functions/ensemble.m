function ensemble(segmentFilename, dataFilename, startFrame, endFrame, experimentName)
...
%     % SI enclosure analysis
% 
%     data = load(dataFilename);
%     if experimentName == "SI"
%         for k=1:length(suffixes)
%         clear ensb_BehavEnclose ensb_Behav10Enclose ensb_Behav20Enclose ensb_Behav30Enclose ensb_Behav40Enclose ensb_Behav50Enclose
%         suffix = suffixes(k);
%         mouseName = "mouse" + suffix;
%         Behav_A50_D10 = data.(mouseName).Behav_A50_D10;
%         Behav_A50_Dfar = data.(mouseName).Behav_A50_Dfar;
%         startFrame=startFrame+1;
%         endFrame=length(Behav_A50_D10);
%         Behav_A50_D10(startS2:endS2)=0;
%         Behav_A50_Dfar(startS2:endS2)=0;
%         NeuP = data.NeuP;
%         DistanceH = data.(mouseName).DistanceH;
...
%         end
%         ensb = struct();
%         ensb.("ensb_Behav10Enclose" + suffix) = struct();
%         ensb.("ensb_Behav10Enclose" + suffix) = ensb_Behav10;
%         ensb.("ensb_Behav20Enclose" + suffix) = struct();
%         ensb.("ensb_Behav20Enclose" + suffix) = ensb_Behav20;
%         ensb.("ensb_Behav30Enclose" + suffix) = struct();
%         ensb.("ensb_Behav30Enclose" + suffix) = ensb_Behav30;
%         ensb.("ensb_Behav40Enclose" + suffix) = struct();
%         ensb.("ensb_Behav40Enclose" + suffix) = ensb_Behav40;
%         ensb.("ensb_Behav50Enclose" + suffix) = struct();
%         ensb.("ensb_Behav50Enclose" + suffix) = ensb_Behav50;
%         ensb.("ensb_BehavEnclose" + suffix) = struct();
%         ensb.("ensb_BehavEnclose" + suffix) = ensb_Behav;
%         save(dataFilename, "-struct", "ensb", "-append");
% 
%         end
%     end
